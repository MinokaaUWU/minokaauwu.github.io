...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Wa(e,t,n){let r=new Float32Array(Aa),i=new G(0,1,0);return new wi({name:`SphericalGaussianBlur`,defines:{n:Aa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:qa(),fragmentShader:`
...
#endif
#include <dithering_fragment>
}`,nl=`uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}`,rl=class extends wi{constructor(e,t,n,r,i=!1){super({name:`EffectMaterial`,defines:{THREE_REVISION:`185`.replace(/\D+/g,``),DEPTH_PACKING:`0`,ENCODE_OUTPUT:`1`},uniforms:{inputBuffer:new pa(null),depthBuffer:new pa(null),resolution:new pa(new W),texelSize:new pa(new W),cameraNear:new pa(.3),cameraFar:new pa(1e3),aspect:new pa(1),time:new pa(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,dithering:i}),e&&this.setShaderParts(e),t&&this.setDefines(t),n&&this.setUniforms(n),this.copyCameraSettings(r)}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(e){this.uniforms.depthBuffer.value=e}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(e){this.defines.DEPTH_PACKING=e.toFixed(0),this.needsUpdate=!0}setDepthBuffer(e,t=tt){this.depthBuffer=e,this.depthPacking=t}setShaderData(e){this.setShaderParts(e.shaderParts),this.setDefines(e.defines),this.setUniforms(e.uniforms),this.setExtensions(e.extensions)}setShaderParts(e){return this.fragmentShader=tl.replace(Z.FRAGMENT_HEAD,e.get(Z.FRAGMENT_HEAD)||``).replace(Z.FRAGMENT_MAIN_UV,e.get(Z.FRAGMENT_MAIN_UV)||``).replace(Z.FRAGMENT_MAIN_IMAGE,e.get(Z.FRAGMENT_MAIN_IMAGE)||``),this.vertexShader=nl.replace(Z.VERTEX_HEAD,e.get(Z.VERTEX_HEAD)||``).replace(Z.VERTEX_MAIN_SUPPORT,e.get(Z.VERTEX_MAIN_SUPPORT)||``),this.needsUpdate=!0,this}setDefines(e){for(let t of e.entries())this.defines[t[0]]=t[1];return this.needsUpdate=!0,this}setUniforms(e){for(let t of e.entries())this.uniforms[t[0]]=t[1];return this}setExtensions(e){this.extensions={};for(let t of e)this.extensions[t]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(e){this.encodeOutput!==e&&(e?this.defines.ENCODE_OUTPUT=`1`:delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(e){return this.encodeOutput}setOutputEncodingEnabled(e){this.encodeOutput=e}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}setDeltaTime(e){this.uniforms.time.value+=e}adoptCameraSettings(e){this.copyCameraSettings(e)}copyCameraSettings(e){e&&(this.uniforms.cameraNear.value=e.near,this.uniforms.cameraFar.value=e.far,e instanceof Yi?this.defines.PERSPECTIVE_CAMERA=`1`:delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(e,t){let n=this.uniforms;n.resolution.value.set(e,t),n.texelSize.value.set(1/e,1/t),n.aspect.value=e/t}static get Section(){return Z}};Number(`185`.replace(/\D+/g,``));var il=255/256;new Float32Array([il/256**3,il/256**2,il/256,il]),new Float32Array([il,il/256,il/256**2,1/256**3]);function al(e,t,n){for(let r of t){let t=`$1`+e+r.charAt(0).toUpperCase()+r.slice(1),i=RegExp(`([^\\.])(\\b`+r+`\\b)`,`g`);for(let e of n.entries())e[1]!==null&&n.set(e[0],e[1].replace(i,t))}}function ol(e,t,n){let r=t.getFragmentShader(),i=t.getVertexShader(),a=r!==void 0&&/mainImage/.test(r),o=r!==void 0&&/mainUv/.test(r);if(n.attributes|=t.getAttributes(),r===void 0)throw Error(`Missing fragment shader (${t.name})`);if(o&&(n.attributes&qc.CONVOLUTION)!==0)throw Error(`Effects that transform UVs are incompatible with convolution effects (${t.name})`);if(!a&&!o)throw Error(`Could not find mainImage or mainUv function (${t.name})`);{let s=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,c=n.shaderParts,l=c.get(Z.FRAGMENT_HEAD)||``,u=c.get(Z.FRAGMENT_MAIN_UV)||``,d=c.get(Z.FRAGMENT_MAIN_IMAGE)||``,f=c.get(Z.VERTEX_HEAD)||``,p=c.get(Z.VERTEX_MAIN_SUPPORT)||``,m=new Set,h=new Set;if(o&&(u+=`	${e}MainUv(UV);
`,n.uvTransformation=!0),i!==null&&/mainSupport/.test(i)){let t=/mainSupport *\([\w\s]*?uv\s*?\)/.test(i);p+=`	${e}MainSupport(`,p+=t?`vUv);
`:`);
`;for(let e of i.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(let t of e[1].split(/\s*,\s*/))n.varyings.add(t),m.add(t),h.add(t);for(let e of i.matchAll(s))h.add(e[1])}for(let e of r.matchAll(s))h.add(e[1]);for(let e of t.defines.keys())h.add(e.replace(/\([\w\s,]*\)/g,``));for(let e of t.uniforms.keys())h.add(e);h.delete(`while`),h.delete(`for`),h.delete(`if`),t.uniforms.forEach((t,r)=>n.uniforms.set(e+r.charAt(0).toUpperCase()+r.slice(1),t)),t.defines.forEach((t,r)=>n.defines.set(e+r.charAt(0).toUpperCase()+r.slice(1),t));let g=new Map([[`fragment`,r],[`vertex`,i]]);al(e,h,n.defines),al(e,h,g),r=g.get(`fragment`),i=g.get(`vertex`);let _=t.blendMode;if(n.blendModes.set(_.blendFunction,_),a){t.inputColorSpace!==null&&t.inputColorSpace!==n.colorSpace&&(d+=t.inputColorSpace===`srgb`?`color0 = sRGBTransferOETF(color0);
	`:`color0 = sRGBToLinear(color0);
	`),t.outputColorSpace===``?t.inputColorSpace!==null&&(n.colorSpace=t.inputColorSpace):n.colorSpace=t.outputColorSpace,d+=`${e}MainImage(color0, UV, `,(n.attributes&qc.DEPTH)!==0&&/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/.test(r)&&(d+=`depth, `,n.readDepth=!0),d+=`color1);
...
`}if(l+=r+`
`,i!==null&&(f+=i+`
`),c.set(Z.FRAGMENT_HEAD,l),c.set(Z.FRAGMENT_MAIN_UV,u),c.set(Z.FRAGMENT_MAIN_IMAGE,d),c.set(Z.VERTEX_HEAD,f),c.set(Z.VERTEX_MAIN_SUPPORT,p),t.extensions!==null)for(let e of t.extensions)n.extensions.add(e)}}var sl=class extends Pc{constructor(e,...t){super(`EffectPass`),this.fullscreenMaterial=new rl(null,null,null,e),this.listener=e=>this.handleEvent(e),this.effects=[],this.setEffects(t),this.skipRendering=!1,this.minTime=1,this.maxTime=1/0,this.timeScale=1}set mainScene(e){for(let t of this.effects)t.mainScene=e}set mainCamera(e){this.fullscreenMaterial.copyCameraSettings(e);for(let t of this.effects)t.mainCamera=e}get encodeOutput(){return this.fullscreenMaterial.encodeOutput}set encodeOutput(e){this.fullscreenMaterial.encodeOutput=e}get dithering(){return this.fullscreenMaterial.dithering}set dithering(e){let t=this.fullscreenMaterial;t.dithering=e,t.needsUpdate=!0}setEffects(e){for(let e of this.effects)e.removeEventListener(`change`,this.listener);this.effects=e.sort((e,t)=>t.attributes-e.attributes);for(let e of this.effects)e.addEventListener(`change`,this.listener)}updateMaterial(){let e=new Jc,t=0;for(let n of this.effects)if(n.blendMode.blendFunction===Q.DST)e.attributes|=n.getAttributes()&qc.DEPTH;else if((e.attributes&n.getAttributes()&qc.CONVOLUTION)!==0)throw Error(`Convolution effects cannot be merged (${n.name})`);else ol(`e`+t++,n,e);let n=e.shaderParts.get(Z.FRAGMENT_HEAD),r=e.shaderParts.get(Z.FRAGMENT_MAIN_IMAGE),i=e.shaderParts.get(Z.FRAGMENT_MAIN_UV),a=/\bblend\b/g;for(let t of e.blendModes.values())n+=t.getShaderCode().replace(a,`blend${t.blendFunction}`)+`
`;(e.attributes&qc.DEPTH)===0?this.needsDepthTexture=!1:(e.readDepth&&(r=`float depth = readDepth(UV);
...
`+i,e.defines.set(`UV`,`transformedUv`)):e.defines.set(`UV`,`vUv`),e.shaderParts.set(Z.FRAGMENT_HEAD,n),e.shaderParts.set(Z.FRAGMENT_MAIN_IMAGE,r),e.shaderParts.set(Z.FRAGMENT_MAIN_UV,i);for(let[t,n]of e.shaderParts)n!==null&&e.shaderParts.set(t,n.trim().replace(/^#/,`
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=tt){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(let n of this.effects)n.setDepthTexture(e,t)}render(e,t,n,r,i){for(let n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){let i=this.fullscreenMaterial;i.inputBuffer=t.texture,i.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(let n of this.effects)n.setSize(e,t)}initialize(e,t,n){this.renderer=e;for(let r of this.effects)r.initialize(e,t,n);this.updateMaterial(),n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}dispose(){super.dispose();for(let e of this.effects)e.removeEventListener(`change`,this.listener),e.dispose()}handleEvent(e){e.type===`change`&&this.recompile()}};new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,-.25,.25,-.125,.125,-.375,.375]),new Float32Array([0,0]),new Float32Array([.25,-.25]),new Float32Array([-.25,.25]),new Float32Array([.125,-.125]),new Float32Array([-.125,.125]),new Uint8Array([0,0]),new Uint8Array([3,0]),new Uint8Array([0,3]),new Uint8Array([3,3]),new Uint8Array([1,0]),new Uint8Array([4,0]),new Uint8Array([1,3]),new Uint8Array([4,3]),new Uint8Array([0,1]),new Uint8Array([3,1]),new Uint8Array([0,4]),new Uint8Array([3,4]),new Uint8Array([1,1]),new Uint8Array([4,1]),new Uint8Array([1,4]),new Uint8Array([4,4]),new Uint8Array([0,0]),new Uint8Array([1,0]),new Uint8Array([0,2]),new Uint8Array([1,2]),new Uint8Array([2,0]),new Uint8Array([3,0]),new Uint8Array([2,2]),new Uint8Array([3,2]),new Uint8Array([0,1]),new Uint8Array([1,1]),new Uint8Array([0,3]),new Uint8Array([1,3]),new Uint8Array([2,1]),new Uint8Array([3,1]),new Uint8Array([2,3]),new Uint8Array([3,3]),ll(0,0,0,0),new Float32Array([0,0,0,0]),ll(0,0,0,1),new Float32Array([0,0,0,1]),ll(0,0,1,0),new Float32Array([0,0,1,0]),ll(0,0,1,1),new Float32Array([0,0,1,1]),ll(0,1,0,0),new Float32Array([0,1,0,0]),ll(0,1,0,1),new Float32Array([0,1,0,1]),ll(0,1,1,0),new Float32Array([0,1,1,0]),ll(0,1,1,1),new Float32Array([0,1,1,1]),ll(1,0,0,0),new Float32Array([1,0,0,0]),ll(1,0,0,1),new Float32Array([1,0,0,1]),ll(1,0,1,0),new Float32Array([1,0,1,0]),ll(1,0,1,1),new Float32Array([1,0,1,1]),ll(1,1,0,0),new Float32Array([1,1,0,0]),ll(1,1,0,1),new Float32Array([1,1,0,1]),ll(1,1,1,0),new Float32Array([1,1,1,0]),ll(1,1,1,1),new Float32Array([1,1,1,1]);function cl(e,t,n){return e+(t-e)*n}function ll(e,t,n,r){return cl(cl(e,t,.75),cl(n,r,.75),.875)}var ul=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),$=o(((e,t)=>{t.exports=ul()}))(),dl=()=>{let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(!t)throw Error(`2D context not available`);t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height);let n=new Gt(e);n.minFilter=D,n.magFilter=D,n.generateMipmaps=!1;let r=[],i=null,a=6.4,o=()=>{t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height)},s=e=>{let n={x:e.x*64,y:(1-e.y)*64},r=1;r=e.age<19.2?(e=>Math.sin(e*Math.PI/2))(e.age/19.2):(e=>-e*(e-2))(1-(e.age-19.2)/44.8)||0,r*=e.force;let i=`${(e.vx+1)/2*255}, ${(e.vy+1)/2*255}, ${r*255}`;t.shadowOffsetX=320,t.shadowOffsetY=320,t.shadowBlur=a,t.shadowColor=`rgba(${i},${.22*r})`,t.beginPath(),t.fillStyle=`rgba(255,0,0,1)`,t.arc(n.x-320,n.y-320,a,0,Math.PI*2),t.fill()};return{canvas:e,texture:n,addTouch:e=>{let t=0,n=0,a=0;if(i){let r=e.x-i.x,o=e.y-i.y;if(r===0&&o===0)return;let s=r*r+o*o,c=Math.sqrt(s);n=r/(c||1),a=o/(c||1),t=Math.min(s*1e4,1)}i={x:e.x,y:e.y},r.push({x:e.x,y:e.y,age:0,force:t,vx:n,vy:a})},update:()=>{o();for(let e=r.length-1;e>=0;e--){let t=r[e],n=t.force*.015625*(1-t.age/64);t.x+=t.vx*n,t.y+=t.vy*n,t.age++,t.age>64&&r.splice(e,1)}for(let e=0;e<r.length;e++)s(r[e]);n.needsUpdate=!0},set radiusScale(e){a=6.4*e},get radiusScale(){return a/6.4},size:64}},fl=(e,t)=>new $c(`LiquidEffect`,`
    ...
    `,{uniforms:new Map([[`uTexture`,new pa(e)],[`uStrength`,new pa(t?.strength??.025)],[`uTime`,new pa(0)],[`uFreq`,new pa(t?.freq??4.5)]])}),pl={square:0,circle:1,triangle:2,diamond:3},ml=`
void main() {
  gl_Position = vec4(position, 1.0);
}
`,hl=`
...
`,gl=10,_l=({variant:e=`square`,pixelSize:t=3,color:n=`#B497CF`,className:r,style:i,antialias:a=!0,patternScale:o=2,patternDensity:s=1,liquid:c=!1,liquidStrength:l=.1,liquidRadius:u=1,pixelSizeJitter:d=0,enableRipples:f=!0,rippleIntensityScale:p=1,rippleThickness:m=.1,rippleSpeed:h=.3,liquidWobbleSpeed:g=4.5,autoPauseOffscreen:v=!0,speed:y=.5,transparent:b=!0,edgeFade:x=.5,noiseAmount:S=0,children:C})=>{let w=(0,_.useRef)(null),T=(0,_.useRef)({visible:!0}),E=(0,_.useRef)(y),D=(0,_.useRef)(null),O=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let r=w.current;if(!r)return;E.current=y;let i=[`antialias`,`liquid`,`noiseAmount`],_={antialias:a,liquid:c,noiseAmount:S},C=!1;if(!D.current)C=!0;else if(O.current){for(let e of i)if(O.current[e]!==_[e]){C=!0;break}}if(C){if(D.current){let e=D.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),D.current=null}let i=new Mc({canvas:document.createElement(`canvas`),antialias:a,alpha:!0,powerPreference:`high-performance`});i.domElement.style.position=`absolute`,i.domElement.style.inset=`0`,i.domElement.style.display=`block`,i.domElement.style.width=`100%`,i.domElement.style.height=`100%`,i.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),r.appendChild(i.domElement),b?i.setClearAlpha(0):i.setClearColor(0,1);let _={uResolution:{value:new W(0,0)},uTime:{value:0},uColor:{value:new Nn(n)},uClickPos:{value:Array.from({length:gl},()=>new W(-1,-1))},uClickTimes:{value:new Float32Array(gl)},uShapeType:{value:pl[e]??0},uPixelSize:{value:t*i.getPixelRatio()},uScale:{value:o},uDensity:{value:s},uPixelJitter:{value:d},uEnableRipples:{value:+!!f},uRippleSpeed:{value:h},uRippleThickness:{value:m},uRippleIntensity:{value:p},uEdgeFade:{value:x}},y=new Fn,C=new Xi(-1,1,1,-1,0,1),w=new wi({vertexShader:ml,fragmentShader:hl,uniforms:_,transparent:!0,depthTest:!1,depthWrite:!1,glslVersion:ct}),O=new Qr(new hi(2,2),w);y.add(O);let k=new ma,A=()=>{let e=r.clientWidth||1,n=r.clientHeight||1;i.setSize(e,n,!1),_.uResolution.value.set(i.domElement.width,i.domElement.height),D.current?.composer&&D.current.composer.setSize(i.domElement.width,i.domElement.height),_.uPixelSize.value=t*i.getPixelRatio()};A();let j=new ResizeObserver(A);j.observe(r);let ee=(()=>{if(typeof window<`u`&&window.crypto?.getRandomValues){let e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0]/4294967295}return Math.random()})()*1e3,M,te,ne;if(c){te=dl(),te.radiusScale=u,M=new Kc(i);let e=new el(y,C);ne=fl(te.texture,{strength:l,freq:g});let t=new sl(C,ne);t.renderToScreen=!0,M.addPass(e),M.addPass(t)}if(S>0){M||(M=new Kc(i),M.addPass(new el(y,C)));let e=new sl(C,new $c(`NoiseEffect`,`uniform float uTime; uniform float uAmount; float hash(vec2 p){ return fract(sin(dot(p, vec2(127.1,311.7))) * 43758.5453);} void mainUv(inout vec2 uv){} void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){ float n=hash(floor(uv*vec2(1920.0,1080.0))+floor(uTime*60.0)); float g=(n-0.5)*uAmount; outputColor=inputColor+vec4(vec3(g),0.0);} `,{uniforms:new Map([[`uTime`,new pa(0)],[`uAmount`,new pa(S)]])}));e.renderToScreen=!0,M&&M.passes.length>0&&M.passes.forEach(e=>e.renderToScreen=!1),M.addPass(e)}M&&M.setSize(i.domElement.width,i.domElement.height);let N=e=>{let t=i.domElement.getBoundingClientRect(),n=i.domElement.width/t.width,r=i.domElement.height/t.height;return{fx:(e.clientX-t.left)*n,fy:(t.height-(e.clientY-t.top))*r,w:i.domElement.width,h:i.domElement.height}};i.domElement.addEventListener(`pointerdown`,e=>{let{fx:t,fy:n}=N(e),r=D.current?.clickIx??0;_.uClickPos.value[r].set(t,n),_.uClickTimes.value[r]=_.uTime.value,D.current&&(D.current.clickIx=(r+1)%gl)},{passive:!0}),i.domElement.addEventListener(`pointermove`,e=>{if(!te)return;let{fx:t,fy:n,w:r,h:i}=N(e);te.addTouch({x:t/r,y:n/i})},{passive:!0});let P=0,re=()=>{if(v&&!T.current.visible){P=requestAnimationFrame(re);return}_.uTime.value=ee+k.getElapsedTime()*E.current,ne&&(ne.uniforms.get(`uTime`).value=_.uTime.value),M?(te&&te.update(),M.passes.forEach(e=>{let t=e.effects;t&&t.forEach(e=>{let t=e.uniforms?.get(`uTime`);t&&(t.value=_.uTime.value)})}),M.render()):i.render(y,C),P=requestAnimationFrame(re)};P=requestAnimationFrame(re),D.current={renderer:i,scene:y,camera:C,material:w,clock:k,clickIx:0,uniforms:_,resizeObserver:j,raf:P,quad:O,timeOffset:ee,composer:M,touch:te,liquidEffect:ne}}else{let r=D.current;if(r.uniforms.uShapeType.value=pl[e]??0,r.uniforms.uPixelSize.value=t*r.renderer.getPixelRatio(),r.uniforms.uColor.value.set(n),r.uniforms.uScale.value=o,r.uniforms.uDensity.value=s,r.uniforms.uPixelJitter.value=d,r.uniforms.uEnableRipples.value=+!!f,r.uniforms.uRippleIntensity.value=p,r.uniforms.uRippleThickness.value=m,r.uniforms.uRippleSpeed.value=h,r.uniforms.uEdgeFade.value=x,b?r.renderer.setClearAlpha(0):r.renderer.setClearColor(0,1),r.liquidEffect){let e=r.liquidEffect;e&&(e.value=l);let t=r.liquidEffect.uniforms.get(`uFreq`);t&&(t.value=g)}r.touch&&(r.touch.radiusScale=u)}return O.current=_,()=>{if(D.current&&C||!D.current)return;let e=D.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),D.current=null}},[a,c,S,t,o,s,f,p,m,h,d,x,b,l,u,g,v,e,n,y]),(0,$.jsx)(`div`,{ref:w,className:r,style:{width:`100%`,height:`100%`,position:`relative`,overflow:`hidden`,...i},"aria-label":`PixelBlast interactive background`,children:C&&(0,$.jsx)(`div`,{style:{position:`relative`,zIndex:1},children:C})})},vl=({text:e})=>(0,$.jsx)(`div`,{className:`marquee-container`,children:(0,$.jsxs)(`div`,{className:`marquee-track`,children:[(0,$.jsx)(`span`,{className:`marquee-item`,children:e}),(0,$.jsx)(`span`,{className:`marquee-item`,children:e})]})}),yl=({active:e,setActive:t,children:n})=>(0,$.jsx)(`div`,{className:e?`modal active`:`modal`,onClick:()=>t(!1),children:(0,$.jsx)(`div`,{className:e?`modal__content active`:`modal__content`,onClick:e=>e.stopPropagation(),children:n})}),bl=({active:e,setActive:t,children:n,duration:r=3e3})=>((0,_.useEffect)(()=>{if(!e)return;let n=setTimeout(()=>t(!1),r);return()=>clearTimeout(n)},[e,r,t]),(0,$.jsxs)(`div`,{className:e?`notification active`:`notification`,onClick:()=>t(!1),children:[(0,$.jsx)(`div`,{className:`notification__content`,children:n}),e&&(0,$.jsx)(`div`,{className:`notification__progress`,style:{animationDuration:`${r}ms`}})]})),xl=[`#edb0cd`,`#f9bec8`,`#eb97a8`,`#ffdce6`,`#ffffff`],Sl=[`star`,`heart`,`sparkle`];function Cl(e,t){e.beginPath();for(let n=0;n<5;n++){let r=Math.PI/2.5*n-Math.PI/2,i=r+Math.PI/5,a=Math.cos(r)*t,o=Math.sin(r)*t,s=Math.cos(i)*t*.45,c=Math.sin(i)*t*.45;n===0?e.moveTo(a,o):e.lineTo(a,o),e.lineTo(s,c)}e.closePath(),e.fill()}function wl(e,t){e.beginPath();let n=t*.6;e.moveTo(0,n*.6),e.bezierCurveTo(-n*1.4,-n*.6,-n*.5,-n*1.6,0,-n*.5),e.bezierCurveTo(n*.5,-n*1.6,n*1.4,-n*.6,0,n*.6),e.closePath(),e.fill()}function Tl(e,t){e.beginPath(),e.moveTo(0,-t),e.lineTo(t*.22,-t*.22),e.lineTo(t,0),e.lineTo(t*.22,t*.22),e.lineTo(0,t),e.lineTo(-t*.22,t*.22),e.lineTo(-t,0),e.lineTo(-t*.22,-t*.22),e.closePath(),e.fill()}var El={star:Cl,heart:wl,sparkle:Tl};function Dl(){let e=(0,_.useRef)(null);return(0,_.useEffect)(()=>{if(window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches)return;let t=e.current,n=t.getContext(`2d`),r=[],i=null,a=null,o=0,s=()=>{t.width=window.innerWidth,t.height=window.innerHeight};s(),window.addEventListener(`resize`,s);let c=(e,t)=>{let n=Sl[Math.floor(Math.random()*Sl.length)],i=xl[Math.floor(Math.random()*xl.length)];r.push({x:e,y:t,vx:(Math.random()-.5)*1.6,vy:-Math.random()*1.2-.4,size:Math.random()*6+5,rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-.5)*.15,life:0,maxLife:Math.random()*30+40,shape:n,color:i}),r.length>200&&r.splice(0,r.length-200)},l=e=>{let t=e.clientX,n=e.clientY;if(i!==null){let e=Math.hypot(t-i,n-a),r=Math.min(Math.floor(e/12),4);for(let e=0;e<r;e++)c(t,n)}i=t,a=n},u=e=>{for(let t=0;t<12;t++)c(e.clientX,e.clientY)};window.addEventListener(`pointermove`,l,{passive:!0}),window.addEventListener(`pointerdown`,u,{passive:!0});let d=()=>{n.clearRect(0,0,t.width,t.height),r=r.filter(e=>e.life<e.maxLife);for(let e of r){e.life++,e.x+=e.vx,e.y+=e.vy,e.vy+=.02,e.rotation+=e.rotationSpeed;let t=e.life/e.maxLife,r=1-t,i=1-t*.5;n.save(),n.translate(e.x,e.y),n.rotate(e.rotation),n.globalAlpha=Math.max(r,0),n.fillStyle=e.color,n.shadowColor=e.color,n.shadowBlur=6,El[e.shape](n,e.size*i),n.restore()}o=requestAnimationFrame(d)};return o=requestAnimationFrame(d),()=>{cancelAnimationFrame(o),window.removeEventListener(`resize`,s),window.removeEventListener(`pointermove`,l),window.removeEventListener(`pointerdown`,u)}},[]),(0,$.jsx)(`canvas`,{ref:e,style:{position:`fixed`,inset:0,width:`100vw`,height:`100vh`,pointerEvents:`none`,zIndex:9999}})}function Ol(){let e=[`uwu`,`i love teto <3`,`44$btc`,`no money 😂`,`minecraft <3`,`roblox <3`,`space-station 14 </3`],[t,n]=(0,_.useState)(!1),[r,i]=(0,_.useState)(!0),[a,o]=(0,_.useState)(!1),[s,c]=(0,_.useState)(!1);function l(e){for(let t=e.length-1;t>0;t--){let n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e}function u(){o(!a)}let d=async()=>{try{await navigator.clipboard.writeText(`minokaa`),c(!0)}catch(e){console.error(`Error copy: `,e)}};return(0,$.jsxs)(`div`,{className:`page`,children:[(0,$.jsx)(Dl,{}),a?(0,$.jsx)(_l,{style:{position:`fixed`,inset:0,width:`100vw`,height:`100vh`},variant:`square`,pixelSize:2,color:`#edb0cd`,patternScale:2.5,patternDensity:1.35,pixelSizeJitter:.45,enableRipples:!1,rippleSpeed:.4,rippleThickness:.12,rippleIntensityScale:1.5,liquid:!1,liquidStrength:.12,liquidRadius:1.2,liquidWobbleSpeed:5,speed:.95,edgeFade:.16,transparent:!0}):null,(0,$.jsx)(`div`,{className:`layout`,children:(0,$.jsxs)(`div`,{className:`content`,children:[(0,$.jsx)(`div`,{className:`baner`,children:(0,$.jsx)(`img`,{src:y,alt:`teto`,className:`baner-img`})}),(0,$.jsx)(`div`,{className:`marquee`,children:(0,$.jsx)(vl,{text:l(e).join(` `.repeat(20))})}),(0,$.jsx)(`div`,{className:`nav`,children:(0,$.jsx)(`nav`,{children:(0,$.jsxs)(`ul`,{children:[(0,$.jsx)(`li`,{children:(0,$.jsx)(`a`,{href:`https://github.com/MinokaaUWU`,children:`github`})}),(0,$.jsx)(`li`,{children:(0,$.jsx)(`a`,{href:`https://t.me/+r3D4liomcbEyZTli`,children:`telegram`})}),(0,$.jsx)(`li`,{children:(0,$.jsx)(`a`,{onClick:()=>d(),children:`discord`})}),(0,$.jsx)(`li`,{children:(0,$.jsx)(`a`,{onClick:()=>n(!0),children:`donate`})}),(0,$.jsx)(`li`,{children:(0,$.jsx)(`a`,{href:`https://x.com/Minokaa_UWU`,children:`xwitter`})})]})})}),(0,$.jsxs)(`div`,{className:`box-row`,children:[(0,$.jsx)(`div`,{className:`box box-large`,children:(0,$.jsxs)(`p`,{children:[`Hiii, Im Mia. Im a full-stack developer proficient in C#, Java, Python, and JS. My tech stack React and Next.js.`,(0,$.jsx)(`br`,{}),(0,$.jsx)(`br`,{}),`I love playing Minecraft, Roblox, Deltarune, PZ, and a bunch of other stuff. I adore Teto, Miku, and the rest of the Vocaloid gang (Teto my beloved).`,(0,$.jsx)(`br`,{}),`:3`,(0,$.jsx)(`br`,{}),`My goal for this year is to earn €5000.`]})}),(0,$.jsxs)(`div`,{className:`box box-small`,children:[(0,$.jsx)(`img`,{src:b,alt:`avatar`}),(0,$.jsx)(`h2`,{children:`Minokaa`}),(0,$.jsx)(`p`,{children:`She/her`})]})]}),(0,$.jsx)(`div`,{className:`box box-full`,children:(0,$.jsx)(`iframe`,{className:`youtube-player`,src:`https://www.youtube.com/embed/kuNixp-wvWM?list=RDaTK72cR-GOY&index=27&autoplay=1&mute=1`,title:`YouTube video player`,frameBorder:`0`,allow:`accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture`,allowFullScreen:!0})})]})}),(0,$.jsx)(`img`,{className:`corner-gif corner-gif-left`,src:`https://static2.klipy.com/ii/935d7ab9d8c6202580a668421940ec81/f3/c7/9nhTBouV.gif`,alt:`teto`}),(0,$.jsx)(`img`,{className:`corner-gif corner-gif-right`,src:`https://media1.tenor.com/m/ISUJN_6fPqIAAAAd/kasane-teto-hatsune-miku.gif`,alt:`teto`}),(0,$.jsxs)(yl,{active:r,setActive:i,children:[(0,$.jsx)(`p`,{children:`Enable at your own risk, may cause lag on weaker devices.`}),(0,$.jsx)(`button`,{onClick:u,children:a?`disable fancy background`:`enable fancy background`})]}),(0,$.jsx)(yl,{active:t,setActive:n,children:(0,$.jsx)(`p`,{children:`USDT TRC20: TEBEBkeKp3k6eMkHurFvn2s1j9MCYxBpvb`})}),(0,$.jsx)(bl,{active:s,setActive:c,duration:2e3,children:(0,$.jsx)(`p`,{children:`discord id copied!`})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(_.StrictMode,{children:(0,$.jsx)(Ol,{})}));